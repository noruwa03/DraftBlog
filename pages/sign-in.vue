        ...
        <div class="lg:col-span-4 col-span-4 lg:pt-32 lg:pb-0 pt-16 pb-16">
          <form @submit.prevent="submitHandler">
            <div class="lg:w-3/5 lg:mx-auto sm:w-3/5 sm:mx-auto w-5/5">
              ...
              <input
                type="email"
                class="outline-none border-[1px] border-gray-100 focus:border-green-400 px-4 py-2 rounded-lg w-full mb-5 mt-2 placeholder:text-slate-500 placeholder:font-serif placeholder:font-normal placeholder:text-sm text-base text-slate-700"
